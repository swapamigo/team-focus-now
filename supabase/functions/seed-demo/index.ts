...
const TEAM_DEFS = [
  { name: 'Team Alpha', emoji: null, color: '#6366f1' },
  { name: 'Team Beta',  emoji: null, color: '#8b5cf6' },
  { name: 'Team Gamma', emoji: null, color: '#10b981' },
  { name: 'Team Delta', emoji: null, color: '#f59e0b' },
];
