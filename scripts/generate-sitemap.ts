...
const entries: SitemapEntry[] = [
  ...
  { path: "/betriebsrat", changefreq: "monthly", priority: "0.9" },
  { path: "/akzeptanz", changefreq: "monthly", priority: "0.8" },
  { path: "/datenschutz-by-design", changefreq: "monthly", priority: "0.9" },
