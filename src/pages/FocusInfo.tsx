...
export default function FocusInfo() {
  ...
  const title: FocusKey = privacy ? "privateTitle" : employee ? "hero2" : "companyBenefit";
  const body: FocusKey = privacy ? "privateBody" : employee ? "heroBody" : "companyDetail";
