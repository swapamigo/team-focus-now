    ...
    <section className="container py-20 md:py-24 border-t border-border/40" id="calculator">
      <div className="max-w-2xl mx-auto text-center mb-12">
        ...
        <p className="mt-4 text-muted-foreground text-lg">
          Im Durchschnitt verschwendet jede:r Mitarbeitende <strong className="text-foreground">720 Arbeitsstunden pro Jahr</strong> am Smartphone –
        ...
        <div className="surface-card p-7 md:p-8 space-y-7">
          ...
          <div className="rounded-2xl bg-secondary/60 p-4 flex items-start gap-3">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Basis: 720 Stunden Smartphone-Ablenkung pro Mitarbeitendem / Jahr (Branchendurchschnitt).{" "}
