...
export default function PrivacyBadge() {
  return (
    <Link
      ...
      aria-label="Datenschutz-Informationen öffnen"
    >
      <ShieldCheck className="h-4 w-4 shrink-0 mt-0.5" />
      <span>
        <strong className="font-semibold">Nur Teamdurchschnitte.</strong> Niemand sieht deine Einzeldaten.
        Teilnahme freiwillig, jederzeit kündbar.
      </span>
    </Link>
  );
}
